...
const PaymentAndServicesStep = forwardRef((props, ref) => {
  ...
  return (
    <form id="paymentAndServices" ref={formRef}>
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            <Label htmlFor="upiId">UPI ID</Label>
            <Input id="upiId" name="upiId" placeholder="" />
          </div>

          <div className="space-y-2">
            <Label htmlFor="bankAccountNumber">Bank Account Number</Label>
            <Input id="bankAccountNumber" name="bankAccountNumber" placeholder="" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <Input id="ifscCode" name="ifscCode" placeholder="" />
          </div>
        ...
        <div className="space-y-2">
          ...
          <Select name="preferredPaymentMode">
            <SelectTrigger>
...
PaymentAndServicesStep.displayName = "PaymentAndServicesStep"
export default PaymentAndServicesStep